    ...
    public sealed class QuestService
    {
        ...
        public bool 接取(string 任务标识)
        {
            ...
            事件.发布(new 日志事件(日志类型.任务, $"接取了任务：{任务.名称}"));
            return true;
        }
        ...
        public void 记录击败(string 敌人标识)
        {
            ...
            ServiceRegistry.Get<日常任务服务>()?.记录击杀(敌人标识);
        }
