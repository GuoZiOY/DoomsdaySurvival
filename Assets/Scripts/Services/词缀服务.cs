...
public sealed class 词缀服务
{
    ...
    private static bool 允许属性(物品数据 物品, 词缀属性 属性)
    {
        switch (物品.类型)
        {
            case "武器": return 属性 == 词缀属性.攻击 || 属性 == 词缀属性.魔攻 || 属性 == 词缀属性.速度 || 属性 == 词缀属性.暴击 || 属性 == 词缀属性.命中;
            case "防具": return 属性 == 词缀属性.防御 || 属性 == 词缀属性.生命 || 属性 == 词缀属性.抗性 || 属性 == 词缀属性.闪避;
            case "饰品": return 属性 == 词缀属性.生命 || 属性 == 词缀属性.抗性 || 属性 == 词缀属性.暴击 || 属性 == 词缀属性.闪避 || 属性 == 词缀属性.速度;
