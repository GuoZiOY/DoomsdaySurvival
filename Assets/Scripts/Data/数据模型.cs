using System;
    ...
    public class 物品数据
    {
        ...
        public string 种类;       // 材料细分（塔科夫式，仅 类型=材料 时使用）：其他/医疗用品/建筑材料/日常用品/工具/易燃物品/电子产品/能源物品/贵重物品/情报物品/食物原料/图纸
    ...
    // 饱食/水分 不单独配置：随制作推进时间按 2 倍速率即时扣除（制作服务 统一结算）。
    [Serializable]
    public class 配方数据
    {
        public string 标识;
        ...
        public int 制作时间分 = 30;  // 制作推进的游戏分钟（饱食/水分 按 2 倍速率 随此时间扣）
